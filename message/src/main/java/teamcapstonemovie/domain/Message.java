...
import teamcapstonemovie.MessageApplication;
...
public class Message  {
    ...
    public static void sendConfirmMsg(ReservationCreated reservationCreated){
        ...
        */
        ...
        repository().findById(reservationCreated.get???()).ifPresent(message->{
