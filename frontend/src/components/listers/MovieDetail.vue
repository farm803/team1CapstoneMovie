<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Date label="ReservatedDate" v-model="item.reservatedDate" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <Boolean label="Scheduled" v-model="item.scheduled" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="ReservatonId" v-model="item.reservatonId" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
